...
//Connect to mysql and once connceted display the database
...
function notEnoughQuantity() {
    console.log("Insufficient quantity! We're sorry, that item is out of stock. What would you like to do?");
    return inquirer.prompt([{
            name: "action",
            type: "list",
        ...
        .then(function(nextSteps) {
            ...
            if (nextSteps.action === "buy a different item") {
                ...
                console.log("Thank you for shopping with Bamazon. Visit us again soon!");
                connection.end();
            }
        });
}